...
# Remove the import statement for HuggingFaceInstructEmbeddings
...
def get_vectorstore(text_chunks):
    model_name = "whereisai/uae-large-v1"  # Update with the correct model name
    ...
    for chunk in text_chunks:
        ...
        embeddings.append(pooled_output.detach().numpy())
